...
use Phpactor\Extension\Maestro\Model\StateMachine\StateMachine as StateMachineInterface;

class RealStateMachine implements StateMachineInterface
{
    /**
     * @var array
     */
    ...
    public function goto(string $name): StateMachineInterface
    {
        $context = new Context();
    ...
    private function satisfy(State $state, Context $context, array $seen = []): void
    {
