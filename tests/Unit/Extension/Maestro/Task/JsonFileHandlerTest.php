...
class JsonFileHandlerTest extends IntegrationTestCase
{
    ...
    public function testJsonFileHandler(array $config, ?array $existingData, array $expectedData)
    {
        ...
        $artifacts = TaskHandlerTester::create(new JsonFileHandler())->handle(JsonFileTask::class, $config, [
...
EOT
        ...
        $artifacts = TaskHandlerTester::create(new JsonFileHandler())->handle(JsonFileTask::class, [
            'targetPath' => 'composer.json',
            'merge' => [
                "require" => [
                    "barfoo/foobar" => "12.2"
