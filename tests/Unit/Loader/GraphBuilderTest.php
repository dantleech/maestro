    ...
    public function provideBuildGraph()
    {
        ...
        yield 'package' => [
            ...
            function (Graph $graph) {
                ...
                $this->assertEquals('phpactor/phpactor', $nodes->get('phpactor/phpactor')->name()->toString());
            }
        ];
        ...
        yield 'merges tasks from prototype' => [
            ...
            function (Graph $graph) {
                ...
                $this->assertEquals('foobar/barfoo#task1', $nodes->get('foobar/barfoo#task1')->name()->toString());
            },
        ];
    }
